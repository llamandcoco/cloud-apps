// Build Worker Lambda - Triggers GitHub Actions to build and upload artifacts
...
function parseBuildCommand(text: string): BuildCommand {
  ...
  // Validate component
  const validComponents = ['router', 'echo', 'deploy', 'status', 'all'];
...
export async function handler(event: SQSEvent): Promise<SQSBatchResponse> {
  logger.info('Build worker invoked', {
